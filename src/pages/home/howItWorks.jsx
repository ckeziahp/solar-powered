  ...
  return (
    <div className="bg-gradient-to-b from-gray-800 to-gray-500 min-h-[120vh] flex items-center justify-center w-full px-8 sm:px-12 md:px-20 lg:px-32">
      ...
      <div className="flex flex-col md:flex-col items-center justify-center w-full max-w-screen-xl px-10 py-24 md:py-20 text-white gap-10">
        ...
        {/* Page Title */}
        <div className="mb-5 mt-7 text-center text-6xl py-6 px-10 w-full lg:pr-32">
        ...
        <div className="container mx-auto py-8 px-10 w-full">
          ...
          <div className="flex flex-col md:flex-row items-center mb-20 px-10 py-20 text-white gap-x-10 gap-y-7 space-x-7">

            {/* Text Content */}
            <div className="w-full md:w-1/2 px-10 text-4xl">
              <h2 className="text-xl sm:text-2xl font-bold text-red-600 mb-4">
                Stage 1: Building the Solar Charger
              </h2>
              <p className="text-white leading-relaxed text-3xl font-bold sm:text-lg">
          ...
          <div className="flex flex-col md:flex-row items-center gap-x-10 gap-y-7 space-x-7">
            ...
            <div className="w-full md:w-1/2 flex justify-center">
              <img
                ...
                className="w-10/12 md:w-8/12 lg:w-7/12 rounded-lg shadow-lg object-cover gap-x-10 gap-y-7 space-x-7"
              />
            </div>
