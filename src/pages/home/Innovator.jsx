      ...
      >
        ...
        <div className="text-left md:order-1">
          ...
          <motion.h1
            ...
            className="text-2xl md:text-3xl font-bold uppercase text-red-600 flex items-center gap-2 mb-6"
          >
            <FaUserGear className="text-red-600" /> About Innovator
          </motion.h1>

          {/* Description */}
          <p className="text-black leading-relaxed text-base md:text-lg mb-8">
